...
def test_backtest_report_data_combines_summary_and_rows() -> None:
    report_data = backtest_report_data(sample_results())
...
def test_backtest_report_to_json_serializes_report_data() -> None:
    report_json = backtest_report_to_json(sample_results())
...
def test_save_backtest_report_json_writes_report_file(tmp_path) -> None:
    ...
    save_backtest_report_json(sample_results(), path)
